 ...
 *--------------------------------------------------------*/
/*
 * activateXLangDebug.ts containes the shared extension code that can be executed both in node.js and the browser.
 */
...
import { FileAccessor } from './xLangRuntime';
...
class InlineDebugAdapterFactory implements vscode.DebugAdapterDescriptorFactory {
	...
	createDebugAdapterDescriptor(_session: vscode.DebugSession): ProviderResult<vscode.DebugAdapterDescriptor> {
		return new vscode.DebugAdapterInlineImplementation(new XLangDebugSession(workspaceFileAccessor));
	}
}
