...
namespace X
{
	namespace AST
	{
		...
		public:
			...
			bool SimpleProcess(XlangRuntime* rt, XObj* pContext, Value& v_l,
			...
			bool Process(XlangRuntime* rt, XObj* pContext, Value& val_l, Expression* expR, Value& v, LValue* lValue)
			{
				bool bOK = true;
			...
			bool RunOne(XlangRuntime* rt, XObj* pContext,
